...
| Idea Trails | `IDEA_TRAILS/README.md` | 25 candidates, **12 OPEN** | IT-014…025 — **IT-020 (master-values) is the authority problem's summit; IT-021 (reflexive auditing) is the circle's gift back to CFA; IT-023 (trust conditions prediction) opens charter candidate #1; six of twelve trails strike the authority wall** |
| Debates | `DEBATES/` | 0 recorded | |
| Extraction packets | `evidence/chat_extractions/` | **4 synthesis packets** · DIG_01 ✅ · SWEEP_02 ✅ · SWEEP_03 ✅ · SWEEP_04 ✅ · **SWEEP_05 ✅** (four consecutive zero-promotion sweeps — plow-through 4-for-4; 3 HIGH candidates queued) · AUX_05 at Stage 3 · DIG_00ABCD in progress · aux: AUX_01 (2–4 postponed), AUX_02–04 ✅ · **sub-dig queue: SW02 A/B/C, SW03 jurisdiction vein, SW04 E/F, SW05 A–D (C = profile prize; "Trust vs Prediction" title now known), AUX_06–08** | protocol v0.2.2 FROZEN; human preflight before every Stage 1; DIG_00 reserved for a preflight-confirmed CFA-zero thread |
