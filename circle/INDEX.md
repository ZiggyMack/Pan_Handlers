...
| Idea Trails | `IDEA_TRAILS/README.md` | 26 candidates, **13 OPEN** | IT-014…026 — **IT-020 (master-values) is the authority problem's summit; IT-021 (reflexive auditing) is the circle's gift back to CFA; IT-023 opens charter candidate #1 (prediction vs trust); IT-026 opens charter candidate #4 (myth as compression); six trails strike the authority wall** |
| Debates | `DEBATES/` | 0 recorded | |
| Extraction packets | `evidence/chat_extractions/` | **4 synthesis packets** · DIG_01 ✅ · SWEEP_02 ✅ · SWEEP_03 ✅ · SWEEP_04 ✅ · SWEEP_05 ✅ (plow-through 4-for-4) · **AUX_06 ✅** (micro — first Myth-as-Compression site; zero promotions) · AUX_05 at Stage 3 · DIG_00ABCD in progress · aux: AUX_01 (2–4 postponed), AUX_02–04 ✅ · **sub-dig queue: SW02 A/B/C, SW03 jurisdiction vein, SW04 E/F, SW05 A–D (C = profile prize; "Trust vs Prediction" title now known), AUX_07–08** | protocol v0.2.2 FROZEN; human preflight before every Stage 1; DIG_00 reserved for a preflight-confirmed CFA-zero thread |
