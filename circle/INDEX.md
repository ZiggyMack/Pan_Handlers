...
| Idea Trails | `IDEA_TRAILS/README.md` | 18 candidates, **5 OPEN** | IT-014 (invariance) · IT-015 (prediction/truth) · IT-016 (Bell — ⚠️ tech gate) · IT-017 (evil/moral generativity — first Grant-adjacent) · IT-018 (map formation/experience/plausibility — candidate-grade) |
| Debates | `DEBATES/` | 0 recorded | |
| Extraction packets | `evidence/chat_extractions/` | **4 synthesis packets** · DIG_01 ✅ (first Grant-relevant) · **COMPOUND_SWEEP_02 ✅ (candidate harvest, zero promotions — plow-through held)** · DIG_00ABCD in progress · aux: AUX_01 (S1; 2–4 postponed), AUX_02 ✅, AUX_03 ✅, AUX_04 ✅ · sub-dig queue: sweep segments A/B/C + AUX_06–08 | protocol v0.2.2 FROZEN; human preflight before every Stage 1; DIG_00 reserved for a preflight-confirmed CFA-zero thread |
