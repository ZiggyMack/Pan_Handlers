...
| Idea Trails | `IDEA_TRAILS/README.md` | 22 candidates, **9 OPEN** | IT-014…022 — **IT-020 (master-values) is the authority problem's summit; IT-021 (reflexive auditing) is the circle's gift back to CFA; five of nine trails strike the same wall** |
| Debates | `DEBATES/` | 0 recorded | |
| Extraction packets | `evidence/chat_extractions/` | **4 synthesis packets** · DIG_01 ✅ · SWEEP_02 ✅ · SWEEP_03 ✅ · **SWEEP_04 ✅** (three consecutive zero-promotion sweeps — plow-through discipline 3-for-3) · AUX_05 at Stage 3 · DIG_00ABCD in progress · aux: AUX_01 (2–4 postponed), AUX_02–04 ✅ · **sub-dig queue: SW02 A/B/C, SW03 jurisdiction vein, SW04 E/F (E = strongest Ziggy profile path), AUX_06–08** | protocol v0.2.2 FROZEN; human preflight before every Stage 1; DIG_00 reserved for a preflight-confirmed CFA-zero thread |
