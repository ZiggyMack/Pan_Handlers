...
| Idea Trails | `IDEA_TRAILS/README.md` | 38 candidates, **25 OPEN** | IT-014…038 — **IT-020 (master-values) is the authority problem's summit; IT-030 its stopping face; IT-036 its calibration face; IT-021 (reflexive auditing) is the circle's gift to CFA; IT-037 (fitness vs quality) + IT-038 (formal-authority leakage) are the excavation's methodological dividends; charter candidates #1/#4 open** |
| Debates | `DEBATES/` | 0 recorded | |
| Extraction packets | `evidence/chat_extractions/` | **4 synthesis packets** · DIG_01 ✅ · SWEEP_02–06 ✅ · **SWEEP_07 ✅** (**six consecutive zero-promotion sweeps — plow-through 6-for-6**; Stage 1 conditional under the G-ANTICIPATED overlay; first A2 against a favored theory) · AUX_06 ✅ (micro) · AUX_05 at Stage 3 · DIG_00ABCD in progress · aux: AUX_01 (2–4 postponed), AUX_02–04 ✅ · **sub-dig queue: SW02 A/B/C, SW03 jurisdiction vein, SW04 E/F, SW05 A–D, SW06 A/B/C, AUX_07–08 — plus the calibration run, badly overdue (engine loop at 7)** | protocol v0.2.2 FROZEN; human preflight before every Stage 1; DIG_00 reserved for a preflight-confirmed CFA-zero thread |
