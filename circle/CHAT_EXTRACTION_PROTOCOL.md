...
| G-ANTICIPATED | same as G-HYPOTHESIZED-BY-ZIGGY — never Grant position evidence | field label (SWEEP_07, 2026-07-17): field-desk name for the same class — Ziggy *predicts* Grant would probably answer X (a Z-DIRECT expectation). Introduced to repair Stage-1 ledgers that collapsed anticipated replies into G-REPORTED; treat G-ANTICIPATED / G-HYPOTHESIZED-BY-ZIGGY as aliases |
