...
| `DIG_COMPOUND_SWEEP_03_foundations_justification_and_jurisdiction.md` | ⚡ Compound sweep: Münchhausen trilemma → framework-relative justification → single-value underdetermination → **jurisdiction of justification** (checklist theme #4 — Z-06's home trench) | STAGE 3 COMPLETE — Stage 4 authorized; keystone correction: underdetermination ≠ contradiction; zero manufactured omissions against an absent Grant; qualifier-operationalization checklist registered |
| `DIG_03.md` | | EMPTY |
| `DIG_04.md` | | EMPTY |
| `DIG_05.md` | | EMPTY |
| `DIG_06.md` | | EMPTY |
