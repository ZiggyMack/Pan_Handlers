...
| `DIG_COMPOUND_SWEEP_15_argument_structure_frame_transfer_and_debate_gamesmanship.md` | ⚡ argument structure, frame transfer, and debate gamesmanship *(topic per filename; header to be completed at Stage-1 filing)* | 🟡 IN PROGRESS — Stage-1 output pasted (G-REPORTED-heavy ledger), review pending; Stages 2–4 pending |
