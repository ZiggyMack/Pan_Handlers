...
| `DIG_COMPOUND_SWEEP_17_credence_metric_selection_doxastic_agency_and_moral_commitment.md` | ⚡ credence, metric selection, doxastic agency, and moral commitment *(topic per filename; header to be completed at Stage-1 filing)* | 🟡 IN PROGRESS — Stage-1 activity pasted (captured at `cccabba`), review pending |
