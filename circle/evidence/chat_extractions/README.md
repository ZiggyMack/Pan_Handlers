...
| `DIG_COMPOUND_SWEEP_08_belief_justification_action_and_belief_rescue.md` | ⚡ Compound sweep: subjective experience as evidence (E1–E4 split); knowledge vs action thresholds; **what defeating a reason actually defeats** (only argument-level defeat is automatic); **belief rescue vs immunization** — Ziggy's admitted rescue impulse is the hottest prey; ⚠️ opens on Nova's reconstruction of an UNAVAILABLE earlier conversation | 🟡 IN PROGRESS — Stages 1–3 reviewed (Stage 1 conditional); **Stage 4 authorized**; both forecasts near-clean; **deepest structural finding: preservation asymmetry** (preservation tools developed, abandonment tools underdeveloped); 7 confirmed A3 omissions incl. Ziggy's rescue arrow uninspected + subjective evidence never role-reversed; **stopping architecture filed** (8 repair vs 7 immunization indicators + decision tree); pre-defeat centrality record safeguard; public reasons incur responsibility; 6 trails at close (IT-045…050) |
