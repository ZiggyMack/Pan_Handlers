...
| `DIG_AUX_03_prediction_ontology_and_effective_theories_2026-07.md` | Prediction vs truth: does predictive success settle ontology? (real clash; Ziggy/Nova; NO Grant evidence — attribution-corrected) | STAGE 3 COMPLETE — Stage 4 authorized with corrections; seeds IT-015; full-Museum crosswalk pending |
| `DIG_AUX_04.md` | | EMPTY (staged for the mining walk) |
