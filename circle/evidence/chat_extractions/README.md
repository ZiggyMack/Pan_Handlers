...
| `DIG_COMPOUND_SWEEP_07_entropy_semantic_compression_materialism_and_narrative_transmission.md` | ⚡ Compound sweep: Shannon entropy vs semantic value; myth-as-compression (encoding/decoding); story vs cookbook; materialism / explanatory levels; religion as experiential-pattern transmission; prediction as mechanism not sovereign — sequel to AUX_06 + SW05 masters branch | 🟡 IN PROGRESS — Stage 1 ⚠️ conditional pass (G-ANTICIPATED overlay binding) · Stages 2–3 ✅ reviewed; **Stage 4 authorized**; 14 moves → 5 families + tools; **largest availability audit yet (10 omissions — Omission 2 is the archive's first A2 against the favored theory: "how can this be validated without a decoder ring?")**; formal-authority residue named as source-quality hazard; transmission quality ≠ content quality; 6 trails ordered at close (IT-032…037); Grant: REPORTED/ANTICIPATED NON-SITE |
