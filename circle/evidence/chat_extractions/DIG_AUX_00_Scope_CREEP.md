# DIG AUX 00 — Scope-Creep Record (contaminated first run)

**Status:** ORIENTATION ONLY — NOT PROMOTABLE
**Disposition:** Workbook-form preservation of the original contaminated Stage-1
run (2026-07-16, old v0.2 prompt, pre-boundary) — the multi-chat corpus that
triggered the v0.2.2 hard source boundary.

> **Canonical copy:** the same output (plus the Stage-2 companion and the
> thread-leads table) is filed in
> `../corpus_sweeps/SWEEP_00_grant_ziggy_orientation_2026-06_to_07.md` — that
> file is authoritative; this one is the dig operator's workbook-form record of
> the scope-creep event. If they ever differ, SWEEP_00 wins.
> Must not generate SOURCE_INDEX entries or profile promotions.
